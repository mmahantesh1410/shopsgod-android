...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if(url.startsWith("reload:")) {
                   ...
                   // webView.loadUrl("https://shopsgod.com/android/otp/");
                    webView.loadUrl("https://shopsgod.com/android/");
                    return true;
                }
                else
                {
        ...
        if(isOnline()) {
            ...
            if(extras != null){
                ...
                webView.loadUrl("https://shopsgod.com/android/index.php?token="+mytoken);
                //webView.loadUrl("https://shopsgod.com/android/otp/");
            }
        } else {
    ...
    public class WebAppInterface {
        ...
        public void opensettings() {
            Intent intRef=new Intent(MainActivity.this,SettingsActivity.class);
